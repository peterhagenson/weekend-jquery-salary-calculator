//THIS WAS MY FIRST TRY AND I MISSED SOME THINGS. LOOK AT CLIENT.JS FOR GRADING.
...
function removeRow() {
  let salaryToRemove = $(this).closest("tr").find(".employeeSalary").text();
  let monthlySalaryToRemove = salaryToRemove / 12;
  totMonthlyCost -= monthlySalaryToRemove;
  displayMonthlyCosts();
